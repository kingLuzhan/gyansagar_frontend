    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          // Remove the TabBar to eliminate the "Details" title
          // bottom: const TabBar(tabs: [Tab(text: 'Details')]),
        ),
        body: TabBarView(
          children: [
            // Existing batch details content
            CustomScrollView(
              slivers: <Widget>[
                SliverList(
                        ...
                        children: <Widget>[
                          ...
                          Row(
                            children: <Widget>[
                              ...
                              _title(
                                context,
                                "${batchModel.classes.length} Classes",
                                fontSize: 18,
                              ),
                            ],
                          ),
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          _title(
                            context,
                            "${batchModel.studentModel.length} Student",
                            fontSize: 18,
                          ),
                          const Spacer(),
                          SizedBox(
                      ...
                      return SliverList(
                        delegate: SliverChildBuilderDelegate((context, index) {
                          ...
                          switch (model.type) {
                            ...
                            default:
                              print(
                                "Unknown timeline item type: ${model.type}",
                              );
